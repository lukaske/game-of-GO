...
public class CaptureGoBoard extends JPanel implements MouseListener, MouseMotionListener, KeyListener {
    ...
    public CaptureGoBoard(int sirina, int visina, int board_size) {
